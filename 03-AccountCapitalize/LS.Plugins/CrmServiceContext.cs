...
// Created via this command line: PAC modelbuilder build --outdirectory C:\Users\Lovro\source\repos\youtube-files\03-AccountCapitalize\LS.Plugins --settingsTemplateFile C:\Users\Lovro\source\repos\youtube-files\03-AccountCapitalize\LS.Plugins\builderSettings.json
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LS.Plugins
{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="LS.Plugins.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<LS.Plugins.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<LS.Plugins.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="LS.Plugins.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<LS.Plugins.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<LS.Plugins.Contact>();
			}
		}
	}
